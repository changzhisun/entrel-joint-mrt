...
class Configurable:
    ...
    def parse_train_file(self):
        return self._config.get('Data','parse_train_file')

    @property
    def parse_dev_file(self):
        return self._config.get('Data','parse_dev_file')

    @property
    def parse_test_file(self):
        return self._config.get('Data','parse_test_file')
    ...
    @property
    def parse_lstm_size(self):
        return self._config.getint('Network','parse_lstm_size')
    ...
    @property
    def n_samples(self):
        return self._config.getint('MRT','n_samples')

    @property
    def alpha(self):
        return self._config.getfloat('MRT','alpha')

    @property
    def mu(self):
        return self._config.getfloat('MRT','mu')
